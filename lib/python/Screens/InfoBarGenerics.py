	...
	def showPiP(self):
			...
			try:
				...
				if self.session.pipshown:
					...
					if int(xres) <= 720 or about.getCPUString() == 'BCM7346B2' or about.getCPUString() == 'BCM7425B2' or about.getCPUString() == 'BCM7429B0' or getBoxType() in ('vusolo4k', 'mutant51', 'dm900', 'sf4008', 'ax51', 'gbquad4k', 'gbue4k', 'e4hdultra'):
